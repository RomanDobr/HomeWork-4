...
import src.ex1.Bus;
import src.ex1.CarWash;
import src.ex1.PassengerCar;
import src.ex2.Airplane;
import src.ex2.Duck;
...
public class Homework4 {
    ...
    public static void ex1() {
        ...
        PassengerCar passengerCar = new PassengerCar(false, 5, 2, 1.8);
        Bus bus = new Bus(false, 12, 3, 2.3);
        CarWash carWash = new CarWash();
        int sum = carWash.doCostOfWashingAll(4, passengerCar) + carWash.doCostOfWashingAll(5, bus);
        System.out.printf("мэрия заплатит %d за мойку машин \n", sum);
        System.out.println("-------------------------------------------------------------------------------------");
    }
    ...
    public static void ex3() {
        ...
        Saundble[] saundbles = {new Human(), new Builder(), new Driver(), new Bird()};

        for (Saundble saundble : saundbles) {
            System.out.println(saundble.saund());
        }
    ...
    public static void ex4() {
        ...
        /***************************************************************************************************
         ******************************Смотри решение задачи в /src/ex4/Runner******************************
         **************************************************************************************************/
